...
if st.session_state.page == "運動紀錄":
    ...
    df1 = pd.DataFrame([
    {"項目": ["12月運動紀錄核可"], "審核者": ["高曼玉個管師"], "時間": [2025-12-30], "點數": ["300點"]},
    {"項目": ["散步30分鐘"], "審核者": ["系統"], "時間": [2025-12-10], "點數": ["20點"]},
    {"項目": ["社區運動中心"], "審核者": ["系統"], "時間": [2025-12-9], "點數": ["27點"]}
    ])
    
    # 修正 '時間' 欄位，確保是字串或 datetime 物件，而不是數學運算
    df1['時間'] = ['2025-12-30', '2025-12-10', '2025-12-9']
    df1['項目'] = ['12月運動紀錄核可', '散步30分鐘', '社區運動中心']
    df1['審核者'] = ['高曼玉個管師', '系統', '系統']
    df1['點數'] = ['300點', '20點', '27點']
        ...
        for p in filtered_places:
            ...
            with st.container(border=True):
                ...
                with col2:
                    ...
                    url = p.get("url", "https://maps.app.goo.gl/HJ4XztPWry83goV36")
                    st.markdown(f"""
